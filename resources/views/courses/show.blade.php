    ...
    <section class="bg-gray-700 py-12 mb-12">
        <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="text-white">
                ...
                <p class="mb-3"><i class="fas fa-chart-line"></i>Nivel:{{$course->level->name}}</p>
                <p class="mb-3"><i class=""></i> Categoria:{{$course->category->name}}</p>
                <p class="mb-3"><i class="fas fa-users"></i> Matriculados:{{$course->students_count}}</p>
                <p class="mb-3"><i class="fas fa-star"></i> Calificación:{{$course->rating}}</p>
            </div>
                    ...
                    <article class="flex mb-6">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="flex items-center mb-2">
                                <img class="h8 w-8 object-cover rounded-full shadow-lg" src="{{$similar->teacher->profile_photo_url}}" alt="">
